...
<head>
    ...
    <title>Input Data Gallery Zona Batik</title>
</head>

<body>
    <div class="input">
        <form action="prosesinputdatagallery.php" name="form1" id="form1" method="POST" enctype="multipart/form-data">
            <fieldset class="dua">
                <center><legend>
                    <h3>Input Data Gallery Zona Batik</h3>
                </legend></center>
                    <center><div class="isi"><table>
                    <tr>
                        <th>ID Foto</th>
                        <th>:</th>
                        <th><input type="text" name="id_gallery" id="id_gallery" size="50" maxlength="15" required></th>
                    </tr>
                    <tr>
                        <th>Kota</th>
                        <th>:</th>
